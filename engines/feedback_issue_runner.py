...
DATA=ROOT/'docs/data.json'; FEEDBACK=ROOT/'docs/user_feedback.json'; RELATIONS=ROOT/'docs/relationships.json'
...
def main():
    ...
    if not issue.get('title','').startswith(('[SCIE FEEDBACK]','[SCIE RELATIONSHIP]')): return
