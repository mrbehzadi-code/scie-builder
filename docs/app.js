...
let people=[],filtered=[],page=1,q='',src='all',cat='all',operationFilter='',snap={},INT={},ER={},PROFILE={},EXT={},ENT={},KG={},LOC={},SOCIAL={},REL={},BUILD={},MERGES=[],MERGE_REQUESTS=[],SOURCE_MONITORS={monitors:[],changes:[]};
...
async function boot(){
  ...
  try{
    ...
    leads();loadMergeRequests();loadSourceMonitors();
