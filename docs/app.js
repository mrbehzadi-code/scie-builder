...
async function boot(){
  ...
  try{
    ...
    applyIntelligence();await loadOverlays();buildMetrics();statusRows(layerState);setupFilters();buildIntel();renderKnowledgeGraph();buildOrgs();setupVerification();await leads();render();
