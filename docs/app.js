...
async function boot(){
  installPersianDigitRendering();bindEvents();updateAdminUI();setupReverificationNotifications();loadBuildMeta();
  try{
    await loadData();
